...
data Sprite
   = Sprite 
        ...
        (Integer, Integer)-- position of the sprite (x,y)
        -- Coordinate        -- position of the gun relative to the above coord
        (Integer, Integer)-- position of the gun relative to the above coord
        --[SpriteImage]     -- a list of the images for this sprite
        [[((Integer, Integer), Char)]]     -- a list of the images for this sprite
        Int               -- current image index 
        Int               -- max image index
        Bool              -- True=visible, False=invisible
        -- [Coordinate]      -- motion sequence
        [(Integer, Integer)]      -- motion sequence
