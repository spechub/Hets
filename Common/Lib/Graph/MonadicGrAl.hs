------------------------------------------------------------------------------
--
--  MonadicGrAl.hs -- Monadic Graph Algorithms  
--
--  (c) 2002 by Martin Erwig [see file COPYRIGHT]
--
--  Contents:
--  * Definition of a graph computation monad:
--      "the monadic graph transformer monad"
--  * Implementation of graph algorithms based on the class GraphM
--
------------------------------------------------------------------------------

module MonadicGrAl where
...
-- graphRec encapsulates a simple recursion schema on graphs
-- 
...
graphNodesM = graphUFold (\(p,v,l,s)->(v:)) []
...
-- dfsM: depth-first search yielding number of nodes
-- 
...
-- dffM: depth-first search yielding dfs forest
-- 
