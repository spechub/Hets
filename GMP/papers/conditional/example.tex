...
solver (CoLoSS\footnote{More information and a web-interface to the tool are
available at \verb|http://www.informatik.uni-bremen.de/cofi/CoLoSS/|}). CoLoSS provides the general coalgebraic framework in which a generic
...
the different optimizations, so that CoLoSS now provides an efficient algorithm for
