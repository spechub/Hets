...
instance ATermConvertible Env where
     toShATerm att0 (Env cm tm as sen env mis cou) = 
	 let (att1,i1) = toShATerm att0 cm
             ...
             (att6,i6) = toShATerm att5 mis
             (att7,i7) = toShATerm att6 cou
         in addATerm (ShAAppl "Env" [i1,i2,i3,i4,i5,i6,i7] []) att6
     fromShATerm att = 
         case aterm of
	    (ShAAppl "Env" [i1,i2,i3,i4,i5,i6,i7] _) ->
		let i1'  = fromShATerm (getATermByIndex1 i1 att)
		    i2'  = fromShATerm (getATermByIndex1 i2 att)
                    ...
                    i7' = fromShATerm (getATermByIndex1 i7 att)
                in (Env i1' i2' i3' i4' i5' i6' i7')
