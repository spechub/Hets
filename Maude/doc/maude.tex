...
Models of rewrite theories are called \emph{$\mathcal{R}$-systems} in \cite{Meseguer92-tcs}.
...
The executability requirements for equations and memberships in a system module are the
