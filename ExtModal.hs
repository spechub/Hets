...
* "ExtModal.ExtModalSystems"	recognition of various systems such as S4, S5 etc.

* "ExtModal.ATC_ExtModal"	ATerm conversion

* "ExtModal.Logic_ExtModal"	the ModalCASL instance of type class 'Logic.Logic.Logic'
