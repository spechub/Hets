...
parseNtriples :: Monad m => String -> m [Triple]
...
-- | takes a filename with n-triples and returns the rdf graph in our syntax
nTriplesParser :: Monad m => String -> m RDFGraph
nTriplesParser fileIn = do
    gr <- parseNtriples fileIn
