...
Hets also provides an implementation of the [H](http://imar.ro/~diacon/forver/forver.html) specification and verification language, allowing to develop Kripke semantics over an arbitrary logic.
