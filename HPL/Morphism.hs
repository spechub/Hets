...
{- |
Module      :  ./HPL/Morphism.hs
Description :  Morphisms in hybrid propositional logic
...
Portability :  portable
  ...
  Definition of morphisms for hybrid propositional logic
