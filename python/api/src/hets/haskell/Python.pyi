...
G_3 = typing.TypeVar("G_3")  # 
G_4 = typing.TypeVar("G_4")  # tStatus
...
class PyTheory(typing.Generic[G_3]): ...
class PyProver(typing.Generic[G_3]): ...
class PyConsChecker(typing.Generic[G_3]): ...
class PyComorphism(typing.Generic[G_3]): ...
class PyProofTree(typing.Generic[G_3]): ...
class PyGMorphism(typing.Generic[G_3]): ...
class PyBasicProof:
...
def theorySentenceContent(x0: SenAttr[G_0,ThmStatus[G_4]]) -> G_0: ...
def theorySentenceGetTheoremStatus(x0: SenAttr[G_0,ThmStatus[G_4]]) -> typing.List[G_4]: ...
def theorySentenceIsAxiom(x0: SenAttr[G_0,ThmStatus[G_4]]) -> bool: ...
def theorySentenceIsDefined(x0: SenAttr[G_0,ThmStatus[G_4]]) -> bool: ...
def theorySentencePriority(x0: SenAttr[G_0,ThmStatus[G_4]]) -> Maybe[str]: ...
def theorySentenceWasTheorem(x0: SenAttr[G_0,ThmStatus[G_4]]) -> bool: ...
...
def checkConservativityNode(x0: LNode[DGNodeLab], x1: LibEnv, x2: LibName) -> IO[typing.Tuple[str, LibEnv, ProofHistory]]: ...
