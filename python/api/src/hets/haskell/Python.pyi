...
class RefinementTreeEdgeType0(RefinementTreeLinkType): ...
class RefinementTreeEdgeType1(RefinementTreeLinkType): ...
class RefinementTreeEdgeType2(RefinementTreeLinkType): ...
class RefinementTreeLink: ...
class RefinementTreeLinkType: ...
...
def getAvailableSpecificationsForRefinement(x0: DGraph) -> typing.List[str]: ...
...
def getRefinementTree(x0: str, x1: DGraph) -> Maybe[Gr[RefinementTreeNode,RefinementTreeLink]]: ...
def globalDecomposition(x0: LibName, x1: LibEnv) -> LibEnv: ...
def globalSubsume(x0: LibName, x1: LibEnv) -> LibEnv: ...
def isRootNode(x0: RefinementTreeNode) -> bool: ...
...
def linkType(x0: RefinementTreeLink) -> RefinementTreeLinkType: ...
...
def rtLinkLab(x0: RefinementTreeLink) -> RTLinkLab: ...
def rtNodeLab(x0: RefinementTreeNode) -> RTNodeLab: ...
