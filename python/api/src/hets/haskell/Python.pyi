...
def checkConservativityEdge(x0: PyConservativityChecker, x1: LinkPointer) -> IO[Result[typing.Tuple[Conservativity, typing.List[GenericTransportType], typing.List[GenericTransportType]]]]: ...
def checkConservativityEdgeAndRecord(x0: PyConservativityChecker, x1: LinkPointer) -> IO[Result[typing.Tuple[typing.Tuple[Conservativity, typing.List[GenericTransportType], typing.List[GenericTransportType]], LibEnv]]]: ...
