...
G_0 = typing.TypeVar("G_0")  # 
G_1 = typing.TypeVar("G_1")  # a
G_2 = typing.TypeVar("G_2")  # sign
G_3 = typing.TypeVar("G_3")  # symbol
G_4 = typing.TypeVar("G_4")  # proof_tree

LibEnv = Map[LibName,DGraph]

class DevGraphLinkKind(typing.Generic[G_0]): ...
...
class DevGraphLinkType(typing.Generic[G_0]): ...
...
class Conservativity(typing.Generic[G_0]): ...
...
class ExtSign(typing.Generic[G_2, G_3]): ...
class GlobalAnnos(typing.Generic[G_0]): ...
class LiteralType(typing.Generic[G_0]): ...
class IRI(typing.Generic[G_0]): ...
class Id(typing.Generic[G_0]): ...
class Token(typing.Generic[G_0]): ...
class LibName(typing.Generic[G_0]): ...
class Diagnosis(typing.Generic[G_0]): ...
class Result(typing.Generic[G_1]): ...
class TimeOfDay(typing.Generic[G_0]): ...
...
class HetcatsOpts(typing.Generic[G_0]): ...
class Disproved(GoalStatus): ...
class GoalStatus(typing.Generic[G_0]): ...
...
class TacticScript(typing.Generic[G_0]): ...
class ProofState(typing.Generic[G_0]): ...
class CSConsistent(SType): ...
class CSError(SType): ...
class CSInconsistent(SType): ...
class CSTimeout(SType): ...
class CSUnchecked(SType): ...
class ConsistencyStatus(typing.Generic[G_0]): ...
class SType(typing.Generic[G_0]): ...
class DGLinkLab(typing.Generic[G_0]): ...
class DGNodeLab(typing.Generic[G_0]): ...
class DGraph(typing.Generic[G_0]): ...
class DGNodeType(typing.Generic[G_0]): ...
class ConsStatus(typing.Generic[G_0]): ...
...
def showDoc(x0: G_1) -> ShowS: ...
def showGlobalDoc(x0: GlobalAnnos, x1: G_1) -> ShowS: ...
def nonImportedSymbols(x0: ExtSign[G_2,G_3]) -> Set[G_3]: ...
def plainSign(x0: ExtSign[G_2,G_3]) -> G_2: ...
...
def resultToMaybe(x0: Result[G_1]) -> Maybe[G_1]: ...
def fromJust(x0: Maybe[G_1]) -> G_1: ...
