...
G_2 = typing.TypeVar("G_2")  # proof_tree
G_3 = typing.TypeVar("G_3")  # a
...
class ProofState: ...
class ProofStatus(typing.Generic[G_2]): ...
class Proved(GoalStatus):
    def __init__(self, x0: bool): ...
class Result(typing.Generic[G_3]): ...
class SType: ...
class TacticScript: ...
class TimeOfDay: ...
class Token: ...
...
def diags(x0: Result[G_3]) -> typing.List[Diagnosis]: ...
...
def goalName(x0: ProofStatus[G_2]) -> str: ...
def goalStatus(x0: ProofStatus[G_2]) -> GoalStatus: ...
...
def maybeResult(x0: Result[G_3]) -> Maybe[G_3]: ...
...
def proofLines(x0: ProofStatus[G_2]) -> typing.List[str]: ...
def proofTree(x0: ProofStatus[G_2]) -> G_2: ...
...
def resultToMaybe(x0: Result[G_3]) -> Maybe[G_3]: ...
def runMMT(x0: HetcatsOpts) -> bool: ...
def serve(x0: HetcatsOpts) -> bool: ...
def showConsistencyStatus(x0: Conservativity) -> str: ...
def showDoc(x0: G_3) -> ShowS: ...
def showGlobalDoc(x0: GlobalAnnos, x1: G_3) -> ShowS: ...
def specNames(x0: HetcatsOpts) -> typing.List[SIMPLE_ID]: ...
def tacticScript(x0: ProofStatus[G_2]) -> TacticScript: ...
...
def usedAxioms(x0: ProofStatus[G_2]) -> typing.List[str]: ...
def usedProver(x0: ProofStatus[G_2]) -> str: ...
def usedTime(x0: ProofStatus[G_2]) -> TimeOfDay: ...
