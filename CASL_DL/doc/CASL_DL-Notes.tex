...
only this named spec? Till] [No, if you parse an OWL DL file the
  ...
  normally provides no meaning in terms of known concepts. Klaus] An
...
\subsection{Structuring an ontology inside an OWL DL-File}
  ...
  look like? Can we discuss that before you start implementingit? Klaus]
...
CASL-DL. Till] [This complicates checking the CASL_DL language. Every
