...
instance Comorphism Rigid2CASL
    ...
    mapSublogic Rigid2CASL _ = Just cFol { cons_features = emptyMapConsFeature }
    map_theory Rigid2CASL = mapTheory
    map_morphism Rigid2CASL = undefined
    map_sentence Rigid2CASL sig sen = map_sentence (BaseCom.CASL2SubCFOL True BaseCom.NoMembershipOrCast) (RSign.caslSign sig) sen
