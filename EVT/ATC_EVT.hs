...
instance (ShATermConvertible g,
          ShATermConvertible a) => ShATermConvertible (MACHINE g a) where
...
instance (ShATermConvertible g,
          ShATermConvertible a) => ShATermConvertible (EVENT g a) where
  toShATermAux att0 xv = case xv of
    EVENT a b c -> do
      (att1, a') <- toShATerm' att0 a
      (att2, b') <- toShATerm' att1 b
...
instance ShATermConvertible g => ShATermConvertible (GUARD g) where
  toShATermAux att0 xv = case xv of
    GUARD a b -> do
      (att1, a') <- toShATerm' att0 a
      (att2, b') <- toShATerm' att1 b
...
instance ShATermConvertible a => ShATermConvertible (ACTION a) where
  toShATermAux att0 xv = case xv of
    ACTION a b -> do
      (att1, a') <- toShATerm' att0 a
      (att2, b') <- toShATerm' att1 b
...
instance (ShATermConvertible g,
          ShATermConvertible a) => ShATermConvertible (EVTSign g a) where
  toShATermAux att0 xv = case xv of
    EVTSign a b -> do
      (att1, a') <- toShATerm' att0 a
      (att2, b') <- toShATerm' att1 b
...
instance (ShATermConvertible g,
          ShATermConvertible a) => ShATermConvertible (EVTMorphism g a) where
  toShATermAux att0 xv = case xv of
