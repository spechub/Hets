...
data GroundConstant = GCI APInt | GCR APFloat deriving (Show, Typeable, Data, Generic)

instance Hashable GroundConstant
...
instance Hashable ConstantName
