...
ana_form ps f =
    case f of
      ...
      AS_BASIC.Quantified_ForAll _ _ _ -> do return need_PF
      AS_BASIC.Quantified_Exists _ _ _ -> do return need_PF
...
isLiteral (AS_BASIC.Quantified_ForAll _ _ _) = False
isLiteral (AS_BASIC.Quantified_Exists _ _ _) = False
...
isPosLiteral (AS_BASIC.Quantified_ForAll _ _ _) = False
isPosLiteral (AS_BASIC.Quantified_Exists _ _ _) = False
