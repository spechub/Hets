...
exportSymToOmdoc _ _ n = return $ (TCSymbol n const_funtype Obj Nothing)
...
exportSenToOmdoc' en vars s =  case s of
     ...
     Atom_sent at ir -> case at of
				   ...
				   Atom pt tts -> OMA $   (exportTermAsPred en pt) : (map (exportTermSeq en vars) tts)  -- imparte ptul ca sa poti da ca parametru si la functia "makePredtype" si pt exportTerm recursiv
...
exportTermAsPred :: Env -> TERM -> OMElement
exportTermAsPred e (Name_term pt) = oms e pt --PredAsItemType
