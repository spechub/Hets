...
public class ATermFunc {
	...
	public ATermFunc() {}
		...
		AFun antiSymObjPropFunc = factory.makeAFun(ASYMMETRIC_OBJECT_PROPERTY.getShortName(), 2, false);
		...
		AFun entityAnnoFunc = factory.makeAFun(ANNOTATION.getShortName(), 3, false);	
		...
		//AFun importsFunc = factory.makeAFun(IMPORTS_DECLARATION.getShortName(), 1, false); NO LONGER AN AXIOM IN OWL 2.0
		...
		AFun subObjPropChainFunc = factory.makeAFun(SUB_OBJECT_PROPERTY_OF.getShortName(), 1, false);
