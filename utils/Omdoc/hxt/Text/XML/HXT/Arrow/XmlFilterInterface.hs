...
import qualified Text.XML.HXT.DOM.NamespaceFilter        as NS
...
parseXmlGeneralEntityValue	:: ArrowXml a => Bool -> String -> a XmlTree XmlTree
parseXmlGeneralEntityValue ext context
				= arrL (XP.parseXmlGeneralEntityValue ext context)
...
propagateNamespaces
  , validateNamespaces		:: ArrowList a => a XmlTree XmlTree

propagateNamespaces		= arrL NS.propagateNamespaces
validateNamespaces		= arrL NS.validateNamespaces
