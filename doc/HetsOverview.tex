...
the final application), \texttt{pretty} and \texttt{parsec}
...
\item[Haskell] Christian, Sonja
\item[Logic] Till
\item[Lottery] ?
\item[Modal] Wiebke
\item[Static] Till
\item[Syntax] Till
\item[ToHaskell] Katja, convert HasCASL to Haskell
...
\item[utils] DrIFT (ag, attribute grammar system is not used)
\end{description}
