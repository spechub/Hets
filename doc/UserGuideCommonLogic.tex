...
CLIF is specified in the Common Logic standard, see
\url{http://iso-commonlogic.org/}. \Hets can directly read in files in
CLIF syntax, and also recursively reads in any imported files.

CLIF itself does not support relative theory interpretations and other
...
\label{HetCASL}
For heterogeneous
specification, \Hets offers the Heterogeneous language \HetCASL.
