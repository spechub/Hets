...
Consider the following Common Logic
text:
...
\Hets checks both the correctness of this specification
 with respect to the Common Logic or \CASL syntax, as
well as its correctness with respect to the static semantics (e.g.\
in \CASL whether all identifiers have been declared before they are used,
...
In order to prove or disprove a theory, it needs to be declared as proof 
