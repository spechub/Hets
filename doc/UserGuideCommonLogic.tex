...
For use with \Hets, we have made a dump of the COLORE contents available in \texttt{CommonLogic/colore} in the \Hets library \cite{hets-library:URL}.\ednote{CL: OK to put it this way? TM: yes}
...
\item Since the amount and kind of sentences sent to an ATP system is a major
  ...
  vary \ednote{CL: From here, my brain can't parse this sentence. TM: improved}and so do the available provers and the comorphism paths leading to provers. Former
