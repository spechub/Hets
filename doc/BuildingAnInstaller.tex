...
\begin{enumerate}
\item create a directory: \texttt{mkdir \HetsInstallDir}  (this step can be ignore, because the Makefile can create the \texttt{\HetsInstallDir})
...
\item lib/
  ...
  \item hets/ 
    ...
    \item hets-XX --- the real binary of hets with version number as extension,
      e.g. \verb,hets-0.52,
    \item OWLParser/owl\_parser --- OWL-DL parser startup script
    \item OWLParser/java/ --- all jar files needed by hets
      \begin{itemize}
