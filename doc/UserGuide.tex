...
Or you can install \Hets on your local file system by \texttt{cd}ing
into \texttt{Tools/Hets}on the CD-ROM and then calling
\begin{quote}
\texttt{./install <dir>}
\end{quote}
where \texttt{<dir>} is an existing directory where \Hets should be
installed.
