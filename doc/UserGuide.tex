...
Comments to: hets-devel@informatik.uni-bremen.de
}
...
(hets-devel@informatik.uni-bremen.de). We will take account your feedback when deciding which
...
(Till.Mossakowski@dfki.de). The mailing list is \url{hets-devel@informatik.uni-bremen.de},
the homepage is
