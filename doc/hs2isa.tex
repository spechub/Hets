...
\abstract{\small We present a tool for the translation of Haskell
  programs to Isabelle HOLCF and Isabelle HOL based on a shallow
  embdedding approach, implemented as part of the Hets system, on top
  of the static analysis
  carried out by Programatica. The translation of monads uses the AWE extension of Isabelle.}\\
